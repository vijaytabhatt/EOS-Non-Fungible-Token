...
CONTRACT nonfungibletoken : public eosio::contract {

     public:
	using contract::contract;
        nonfungibletoken( name receiver, name code, datastream<const char*> ds)
	...
	ACTION setpayer(name payer, id_type id);
        ...
        //generate unique uuid based on arguments passed to function 
	...
	token_index tokens;
        ...
        void mint(name owner, name payer, asset value, string uri, string name);
